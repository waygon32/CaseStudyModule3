...
<form action="/product?action=create" method="post">
    <table align="center">
        ...
        <tr>
            ...
            <td>Đường dẫn ảnh</td>
        </tr>
        <tr>
            <td><input type="text" name="typeId" placeholder=" type Id" id="typeID" required><br></td>
            ...
            <td><input type="text" name="describe" id="describe" placeholder="describe" required></td>
